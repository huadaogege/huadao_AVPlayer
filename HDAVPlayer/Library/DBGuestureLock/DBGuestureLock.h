...
@property (nonatomic, copy)NSString *firstInPutPassword;
...
+(instancetype)lockOnView:(UIView*)view offsetFromBottom:(CGFloat)offset onPasswordSet:(void (^)(DBGuestureLock *lock, NSString *password))onPasswordSet ;
