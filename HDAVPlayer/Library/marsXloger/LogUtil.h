...
/**
 ...
 @example:
          UU_XLOG_INFO("MCM", @"重命名操作:docId:%@, oldDocName:%@, renameTo:%@", docInfo.docId, docInfo.oldDocName, docInfo.renameTo);
 */

#define UU_XLOG_INFO(module, format, ...) LogInternal(kLevelInfo, module, "", __LINE__, __FUNCTION__, @"logInfo:", format, ##__VA_ARGS__)

#define UU_XLOG(format, ...) LogInternal(kLevelInfo, "UU", __FILENAME__, __LINE__, __FUNCTION__, @"logInfo:", format, ##__VA_ARGS__)

#define NSLog UU_XLOG
