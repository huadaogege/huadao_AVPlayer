...
-(instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        UIImageView *imagev = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"a_voice_bg"]];
        ...
        _btnImage = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"volume.png"]];
        ...
        _iconImg.image = [UIImage imageNamed:@"a_icon_slider"];
...
- (void)soundZero {
    if (_volumeBtn.tag == 0 || _soundValue == 0) {
        ...
        [self setVolume:0];
        _btnImage.image = [UIImage imageNamed:@"volume_none.png"];
    } else {
        _volumeBtn.tag = 0;
        [self setVolume:_soundValue];
        _btnImage.image = [UIImage imageNamed:@"volume.png"];
    }
}
