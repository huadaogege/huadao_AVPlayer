...
- (void)setDirection:(VideoMoveDirection)direction nowtime:(NSString *)nowStr totalTime:(NSString *)totalStr {
    ...
    UIImage *image = direction == kVideoMoveDirectionLeft?[UIImage imageNamed:@"a_fast_reverse.png"] :[UIImage imageNamed:@"a_Fast_forward.png"];
...
- (instancetype)initBottomViewWith:(CGRect)frame {
    ...
    if (self) {
        ...
        bottomBackGorund.image = [UIImage imageNamed:@"a_control_bg"];
        ...
        rewindImg.image = [UIImage imageNamed:@"a_icon_reverse"];
        ...
        [_playButton setImage:[UIImage imageNamed:@"a_icon_play"] forState:UIControlStateNormal];
        ...
        forwardImg.image = [UIImage imageNamed:@"a_icon_forward"];
...
- (void)setPlayBtnStatus:(BOOL)isplay {
    UIImage *image = isplay?[UIImage imageNamed:@"a_icon_pause"] :[UIImage imageNamed:@"a_icon_play"];
    [_playButton setImage:image forState:UIControlStateNormal];
}

- (void)setRotateBtnStatus:(BOOL)isLand {
    UIImage *image = isLand? [UIImage imageNamed:@"video_poscreen.png"]: [UIImage imageNamed:@"video_allscreen.png"];
...
- (instancetype)initTopViewWith:(CGRect)frame {
    ...
    if (self) {
        ...
        doneBtnImg.frame = CGRectMake(14.5*WINDOW_SCALE,
                                      ...
                                      34*WINDOW_SCALE,
                                      34*WINDOW_SCALE);
        doneBtnImg.image = [UIImage imageNamed:@"list_icon-back"];
